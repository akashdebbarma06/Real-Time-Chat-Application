      ...
      <section className="hidden border-r bg-foreground px-12 py-14 text-background lg:flex lg:flex-col lg:justify-between dark:bg-card dark:text-foreground">
        ...
        <div className="max-w-xl space-y-7">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-sm text-white/80 dark:text-foreground/80">
            <Sparkles className="size-4" />Conversations that feel instant
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <p className="mt-1 text-sm text-white/55 dark:text-muted-foreground">Row-level policies protect conversations and files.</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              <MessageCircleMore className="mb-3 size-5 text-primary" />
              <p className="font-medium">Realtime everywhere</p>
              <p className="mt-1 text-sm text-white/55 dark:text-muted-foreground">Presence, typing, receipts, and live messages.</p>
            </div>
          </div>
        </div>
